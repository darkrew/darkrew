                ...
                <div className="relative flex-auto">
                  <div className=" mb-24 max-w-screen-xl mt-16 px-8 grid gap-8 grid-cols-1 md:grid-cols-2 md:px-12 lg:px-16 xl:px-32 py-16 mx-auto bg-[#ccc] text-[var(--background-color)] rounded-lg shadow-lg">
                    ...
                    <div className="">
                      ...
                      <div className="mt-8">
                        <button className="uppercase text-lg font-bold tracking-wide border border-[var(--main-color)] text-[var(--background-color)] bg-[var(--main-color)] hover:bg-[#ccc] text-[#121212] duration-75 p-3 rounded-lg w-full focus:outline-none focus:shadow-outline">
                          Send Message
                        </button>
                      </div>
                    </div>
