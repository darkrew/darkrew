...
function ServicesCards({ svg, title, description }) {
  return (
    <div>
      ...
      <h3 className="mb-2 text-md font-bold text-[var(--main-color)] uppercase headings  text-center lg:text-lg xl:text-xl">
        {title}
      </h3>
      <p className="text-[var(--text-color)] subHeadings xl:text-lg text-center">
        {description}
      </p>
    </div>
  );
